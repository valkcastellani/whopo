...
@RestController
@RequestMapping("/api/whopo-kafka")
public class WhopoKafkaResource {

    private final Logger log = LoggerFactory.getLogger(WhopoKafkaResource.class);
    ...
    public WhopoKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
